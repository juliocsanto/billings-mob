          ...
          <div style={{ padding: '20px 22px' }}>
            ...
            {form.stamp === 'sangramento' && (
              <div style={{ marginBottom: 18 }}>
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {BLEEDING.map(b => (
                    <Pill key={b.id} label={b.label} active={form.bleeding === b.id} color='var(--stamp-sangramento-ink)'
              ...
              <div style={{ marginBottom: 18 }}>
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {TIPO_OBSERVACAO.map(t => (
                    <Pill key={t.id} label={t.label} active={form.tipo_observacao === t.id} color='var(--stamp-sangramento-ink)'
